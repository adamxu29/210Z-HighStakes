...
void Eclipse::Autonomous_Paths::red_awp_rush()
{
	...
	chassis.setPose(0, 0, 0);
	chassis.moveTo(0, -50, 1000, 90); // move back into mogo
	...
	chassis.setPose(0, 0, 0);
	chassis.moveTo(0, -20.6, 5000, 150); // move back onto goal
...
void Eclipse::Autonomous_Paths::blue_awp_rush()
{
	...
	// TUNE TO NOT CROSS AUTO LINE!
	chassis.setPose(0, 0, 0);
	chassis.moveTo(0, -20.6, 5000, 100); // move back onto goal (-21.2)
...
void Eclipse::Autonomous_Paths::skills()
{
	...
	chassis.setPose(0, 0, 0);
	chassis.moveTo(0, -35, 1000, 120); // clamp goal
	...
	wall_stake.move_absolute(-500, 200);
	...
	chassis.setPose(0, 0, 0);
	chassis.moveTo(0, 25, 1000); // intake ring
	pros::delay(1500);			   // wallstake intake delay (prime position) *NOTE: decrease if ready before-hand
	...
	chassis.setPose(0, 0, 0);
	chassis.moveTo(0, 36, 1000, 100);

	pros::delay(500);
	intake.move_voltage(0);

	r_pid.set_r_constants(2.5, 0, 15);
	r_pid.rotation_pid(-150, 90, 2);

	chassis.setPose(0, 0, 0);
	chassis.moveTo(0, -45, 1000, 90);
